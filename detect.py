...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        # Set a confidence threshold, e.g., 80 is a common choice
        if conf < 75:
            ...
            # Show "Unknown Person" if confidence is high (i.e., not a match)
            cv2.putText(img, "Unknown Person", (x, y + h + 20), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 0, 255), 2)
